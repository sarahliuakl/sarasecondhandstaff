...
### 进阶产品增强
- [ ] 部分产品应当有 [仅见面交易] 例如电脑，手机等贵重物品，更适合当面钱货两清

### 安全性增强
- [ ] **密钥管理**: 移除硬编码的SECRET_KEY和API密钥
  - 使用环境变量或配置文件
  - 实现.env文件支持
  - 更新部署文档
...
- [ ] **邮件通知**: 实现订单确认邮件
  - 使用resend发送邮件 文档 https://resend.com/docs/send-with-flask
  - 设计邮件模板
  - 实现邮件队列
...
- [ ] **管理员登陆**: 创建管理后台登陆
  ...
  - 管理员信息修改页面
  - 密码修改
  - 网站信息设置（网站名称，域名，等等必要信息）

- [ ] **管理员界面**: 创建产品和订单管理后台
  - 产品CRUD操作
  - 订单状态管理 【需要仔细思考逻辑】（订单状态更变需要邮件提醒）
  - 库存管理 【库存可修改 当库存为0时 则显示售出】
  - 客户留言管理 【需要防止垃圾邮件】
